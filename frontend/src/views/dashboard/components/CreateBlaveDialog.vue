...
import type { NewBlave } from '@/domains/blaves/contracts'
  ...
  <Teleport to="body">
    ...
    >
      <section
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="create-blave-title"
      >
        <header class="flex items-start justify-between gap-4">
          <div class="min-w-0">
            ...
            <p class="mt-2 text-sm leading-6 font-medium text-slate-600 dark:text-slate-400">
              Name the execution so the team can track movement, risks, and change from one place.
            </p>
          </div>
        ...
        <form class="mt-5 grid gap-4" novalidate @submit.prevent="submitForm">
          <label class="grid gap-2">
            ...
            <input
              ...
              name="flowTitle"
              autocomplete="off"
              placeholder="Customer onboarding Q3"
              :disabled="isPending"
          ...
          >
            ...
            <span class="grid gap-1">
              ...
              <span class="text-xs leading-5 font-medium text-slate-500 dark:text-slate-400">
                Keep the execution easy to find in flow lists and shortcuts.
              </span>
            </span>
          </label>
