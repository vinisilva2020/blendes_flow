...
from apps.blendes_flow.exceptions.kref_pratices import (
    ...
    KrefPraticeBlaveNotFoundError,
    KrefPraticeBoundaryNotFoundError,
    KrefPraticeDomainError,
    KrefPraticeFacetDescriptionNotFoundError,
    KrefPraticeMovementNotAllowedError,
    KrefPraticeNotFoundError,
    KrefPraticeRiskNotFoundError,
    KrefPraticeSchapterNotFoundError,
)

DOMAIN_ERROR_STATUS = {
    KrefPraticeBlaveInactiveOrganizationError: 409,
    KrefPraticeBlaveNotFoundError: 404,
    KrefPraticeBoundaryNotFoundError: 404,
    KrefPraticeFacetDescriptionNotFoundError: 404,
    KrefPraticeMovementNotAllowedError: 409,
    KrefPraticeNotFoundError: 404,
    KrefPraticeRiskNotFoundError: 404,
    KrefPraticeSchapterNotFoundError: 404,
}
...
class KrefPraticeAPIView(APIView):
    """Aplica o contrato publico de erros para endpoints de praticas KREF."""

    def handle_exception(self, exc):
        if isinstance(exc, KrefPraticeDomainError):
            return Response(
                {
                    "error": {
                        "code": exc.code,
