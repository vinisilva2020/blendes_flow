...
DOMAIN_ERROR_STATUS = {
    BoundaryAlreadyExistsError: 409,
    BoundaryBlaveInactiveOrganizationError: 409,
    BoundaryBlaveNotFoundError: 404,
    BoundaryHasChildrenError: 409,
    BoundaryInvalidParentError: 400,
...
class BoundaryAPIView(APIView):
    """Aplica o contrato publico de erros para endpoints de boundaries."""

    def handle_exception(self, exc):
        if isinstance(exc, BoundaryDomainError):
            return Response(
                {
                    "error": {
                        "code": exc.code,
