...
from apps.blendes_flow.exceptions.facet_descriptions import (
    ...
    FacetDescriptionBlaveNotFoundError,
    FacetDescriptionBoundaryNotFoundError,
    FacetDescriptionDomainError,
...
DOMAIN_ERROR_STATUS = {
    FacetDescriptionAlreadyExistsError: 409,
    FacetDescriptionBlaveInactiveOrganizationError: 409,
    FacetDescriptionBlaveNotFoundError: 404,
    FacetDescriptionBoundaryNotFoundError: 404,
    FacetDescriptionMovementNotAllowedError: 409,
    FacetDescriptionNotFoundError: 404,
    FacetDescriptionSchapterNotFoundError: 404,
}
...
class FacetDescriptionAPIView(APIView):
    """Aplica o contrato publico de erros para endpoints de facet descriptions."""

    def handle_exception(self, exc):
        if isinstance(exc, FacetDescriptionDomainError):
            return Response(
                {
                    "error": {
                        "code": exc.code,
