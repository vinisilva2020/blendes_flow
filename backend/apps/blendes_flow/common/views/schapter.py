...
DOMAIN_ERROR_STATUS = {
    SchapterAlreadyExistsError: 409,
    SchapterBlaveInactiveOrganizationError: 409,
    SchapterBlaveNotFoundError: 404,
    SchapterBoundaryNotFoundError: 404,
...
class SchapterAPIView(APIView):
    """Aplica o contrato publico de erros para endpoints de schapters."""

    def handle_exception(self, exc):
        if isinstance(exc, SchapterDomainError):
            return Response(
                {
                    "error": {
                        "code": exc.code,
